...
from tools.co3d.utils.normalize import intersect_skew_lines_high_dim
...
def cameras_to_rays(
    ...
    origins = cameras.get_camera_center().unsqueeze(1)  # (N, 1, 3) `get_camera_center` that returns the optical center of the camera in world coordinates
