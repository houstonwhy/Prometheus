...
additional_map = [
    ...
    # conv_in.weight", "conv_in.bias", , "time_embedding.linear_1.bias", "time_embedding.linear_2.weight", "time_embedding.linear_2.bias", "conv_norm_out.weight", "conv_norm_out.bias", "conv_out.weight", "conv_out.bias". 
]
